...
class BinarySearchTree:
    ...
    def delete(self, data):
        ...
        # 내가 쓴 코드. 지우려는 노드가 부모 노드의 왼쪽 노드인지 오른쪽 노드인지에 따라 다르게 해줘야 한다.
        # 경우 2: 지우려는 노드가 자식이 하나인 노드일 때:
        # elif node_to_delete.left_child is not None:  # left_child가 있는 경우
        #     if node_to_delete is self.root:
        ...
        #
        # elif node_to_delete.right_child is not None:  # right_child가 있는 경우
        #     if node_to_delete is self.root:
