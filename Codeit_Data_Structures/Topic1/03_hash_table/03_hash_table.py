...
class HashTable:
    ...
    def look_up_value(self, key):
        ...
        linked_list = self._table[index]

        target_node = linked_list.find_node_with_key(key)
    ...
    def insert(self, key, value):
        ...
        key_in_list = linked_list.find_node_with_key(key)
        if key_in_list is None:
            linked_list.append(key, value)
        else:
            linked_list.delete(key_in_list)
            linked_list.append(key, value)
