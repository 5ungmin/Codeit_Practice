...
# 자전거의 속도를 출력한다
print(bicycle)     # 이 자전거는 현재 5.0km/h로 주행 중입니다.

# 자전거만 주행을 멈춰준다
bicycle.stop()

# 결과 값을 출력한다
print(bicycle)     # 이 자전거는 현재 0km/h로 주행 중입니다.
print(car)         # 이 일반 자동차는 현재 50.0km/h로 주행 중입니다.
print(sports_car)  # 이 스포츠카는 현재 200km/h로 주행 중입니다.
